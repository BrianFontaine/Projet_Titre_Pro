            ...
            <form action="../controllers/register_ctrl.php" method="POST">
                ...
                <label class="text-dark" for="lastname">Votre prénom : </label>
                    <div class="col-md-12 mt-2">
                        ...
                        <?php if(!empty($errors)) { ?> <div class="alert alert-danger"><?= $errors['lastname'];?></div><?php } ?>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <?php if(!empty($errors)) { ?> <div class="alert alert-danger"><?= $errors['firstname'];?></div><?php } ?>
                    </div>
                    <label class="text-dark" for="mail">Votre email : </label>
                    <div class="col-md-12 mt-2">
                        <input type="text" class="form-control" placeholder="Email" id="mail" name="mail">
                        <?php if(!empty($errors)) { ?> <div class="alert alert-danger"><?= $errors['mail'];?></div><?php } ?>
                    </div>
                    ...
                    <div class="col-md-12 mt-2 mr-n5 pr-2">
                        ...
                        <?php if(!empty($errors)) { ?> <div class="alert alert-danger"><?= $errors['birthdate'];?></div><?php } ?>
                    </div>
                    ...
                    <div class="col-md-12 mt-2 ">
                        ...
                        <?php if(!empty($errors)) { ?> <div class="alert alert-danger"><?= $errors['phone'];?></div><?php } ?>
                    </div>
